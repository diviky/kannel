...
dlr_mask INTEGER NULL, dlr_url VARCHAR(MAX) NULL, pid INTEGER NULL, alt_dcs INTEGER NULL, \
...
validity, deferred, dlr_mask, dlr_url, pid, alt_dcs, rpi, charset, boxc_id, binfo, meta_data, log_data \
FROM %S"
...
deferred, dlr_mask, dlr_url, pid, alt_dcs, rpi, charset, boxc_id, binfo, meta_data, foreign_id, log_data) VALUES (%S, \
