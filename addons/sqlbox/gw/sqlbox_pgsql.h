...
dlr_mask, dlr_url, pid, alt_dcs, rpi, charset, boxc_id, binfo, meta_data, log_data FROM %S LIMIT 1 OFFSET 0"
...
dlr_mask, dlr_url, pid, alt_dcs, rpi, charset, boxc_id, binfo, meta_data, foreign_id, log_data) VALUES (%S, %S, %S, \
